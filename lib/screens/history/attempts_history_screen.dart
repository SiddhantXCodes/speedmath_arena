...
class _AttemptsHistoryScreenState extends State<AttemptsHistoryScreen> {
  ...
  Future<void> _loadAllAttempts() async {
    try {
      final practiceProvider = Provider.of<PracticeLogProvider>(
        context,
        listen: false,
      );
      ...
      all.sort((a, b) {
        final adate = a['timestamp'] ?? a['date'];
        final bdate = b['timestamp'] ?? b['date'];
      ...
      body: questions.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final bool isCorrect = given.trim() == correct.trim();
